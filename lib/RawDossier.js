    ...
    this.addFolder = (fsFolderPath, barPath, depth, callback) => {
        ...
        if (depth === 0) {
            ...
            loadBarForPath(barPath, (err, dossierContext) => {
                ...
                dossierContext.archive.addFolder(fsFolderPath, dossierContext.relativePath, callback);
            });
        }
    };
    ...
    this.addFile = (fsFilePath, barPath, depth, callback) => {
        ...
        if (depth === 0) {
            ...
            loadBarForPath(barPath, (err, dossierContext) => {
                ...
                dossierContext.archive.addFile(fsFilePath, dossierContext.relativePath, callback);
            });
        }
    };
