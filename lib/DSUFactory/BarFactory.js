...
function BarFactory(options) {
     ...
     * @return {SecretDID}
     */
    const createKeySSI = (keySSIType, callback) => {
        ...
        const keySSI = this.keySSIFactory.create(keySSIType);
        keySSI.initialize(this.dlDomain, undefined, undefined, undefined, options.favouriteEndpoint, callback);
    }
