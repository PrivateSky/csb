...
function Factory(options) {
    ...
    const favouriteEndpoint = options.favouriteEndpoint;
     ...
     */
    const initialize = () => {
        const builtinDSURepr = require('../BuiltinDSURepresentations');
        ...
        const nodeDossierFactory = new NodeDossierFactory({keySSIFactory: options.keySSIFactory});
